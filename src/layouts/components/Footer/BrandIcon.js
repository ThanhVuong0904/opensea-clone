export function AndreessenIcon({ className }) {
    return (
        <svg className={className} viewBox="0 0 135 32">
            <path
                class="st1"
...
export function ParadigmIcon({ className }) {
    return (
        <svg
            className={className}
            id="Layer_1"
...
export function CombinatorIcon({ className, fillText }) {
    return (
        <svg className={className} viewBox="0 0 140 30">
            <path d="M28.9,0.9H0v28.9h28.9V0.9z" fill="none" stroke="#fbfdff"></path>
            <path
                class="YCombinatorLogo--y"
...
export function CoatueIcon({ className }) {
    return (
        <svg
            className={className}
            id="Layer_1"
...
export function FoundersFundIcon({ className }) {
    return (
        <svg className={className} viewBox="0 0 206 15">
...
export function BlockChainCapitalIcon({ className }) {
    return (
